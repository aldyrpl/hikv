...
public class MainActivity extends Activity {
    ...
    private static final String IP_ADDRESS = "202.152.49.162";
    private static final String IP_ADDRESS_2 = "202.152.49.162";
    private static final int PORT = 8000;
    private static final String USER_NAME = "admin";
    private static final String USER_NAME_2 = "admin";
    private static final String PASSWORD = "Utility123456";
    private static final String PASSWORD_2 = "Utility123456";
    //----------------------------------------------------------------------------------------------
...
//                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hikUtil2.setDeviceData(IP_ADDRESS_2, 8002, USER_NAME_2, PASSWORD_2);
